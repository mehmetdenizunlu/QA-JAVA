...
public class _02_JavaDataType {
    public static void main(String[] args) {
        int sayi;
        // default olarak bütün tam sayıları int olarak kabul eder
        byte byteDeger =7;
        short shortDeger = 1645;
        int intDeger = 15;
        long longDeger = 232323232323L; // Default olarak tam sayıları INT kadul ettiği için
